<div class="container py-8">
    ...
    <x-table-responsive>
        <div class="px-6 py-4 flex">
            <input wire:keydown="limpiar_page" wire:model="search" type="text" class="border-gray-300 rounded-md flex-1 shadow-sm" placeholder="Ingrese el nombre de un curso">
