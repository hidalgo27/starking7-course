            ...
            <div class="card-body bg-gray-100">
                ...
                @if($requirement->id == $item->id)
                    <form wire:submit.prevent="update">
                        <input wire:model="requirement.name" type="text" class="form-input">
    ...
    <article class="card">
        <div class="card-body bg-gray-100">
            <form wire:submit.prevent="store">
                <input wire:model="name" type="text" class="form-input" placeholder="Agregar el nombre de un requerimiento">
