<form class="pt-2 relative mx-auto text-gray-600" autocomplete="off">
    ...
    <button type="submit" class="btn-primary absolute right-0 top-0 mt-2">Buscar</button>
    @if($search)
        <ul class="absolute z-10 left-0 w-full bg-white mt-1 rounded-lg overflow-hidden">
