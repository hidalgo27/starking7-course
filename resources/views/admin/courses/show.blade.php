    ...
    <section class="bg-gray-700 py-12 mb-12">
        <div class="container grid grid-cols-1 lg:grid-cols-2 gap-6">
            <figure>
                ...
                @else
                    <img class="h-60 w-full object-cover" src="https://images.pexels.com/photos/5905710/pexels-photo-5905710.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=750&w=1260" alt="">
                @endif
            </figure>
            ...
            <div class="order-1 lg:order-2">
                <section class="card mb-4">
                    <div class="card-body">
                        ...
                        <a href="{{route('admin.courses.observation', $course)}}" class="btn btn-danger block text-center w-full mt-4">Observar curso</a>
                    </div>
                </section>
